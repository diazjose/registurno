                    ...
                    <div class="card-body">
                        ...
                        <form id="form-turno">
                            ...
                            <div class="form-group">
                                ...
                                <small id="dnilHelp" class="form-text text-muted">Ingrese DNI tecleando numero por numero sin puntos, ni comas, ni otros caracteres que nos sean numeros</small>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="tramite" id="tramite">
                                    <option selected disabled value="0">--Seleccionar Tramite--</option>
