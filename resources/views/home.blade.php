                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">                                    
                                    ...
                                    <hr>
                                    <p>
                                        <h5><strong>De:</strong> {{ $turno->dni }}</h5>
                                    </p>
                                    <p>
                                        <h5><strong>Dia:</strong> {{ date('d/m/Y',strtotime($turno->fecha)) }}</h5>
                                    </p>
                                    <p>
                                        <h5><strong>Hora:</strong> {{ $turno->hora }}</h5>  
                                    </p>
                                    <hr>
                                    <small><strong>Presentarse con el dni de titular unos minutos antes de la hora del turno para anunciarse.</strong></small>
                                    <hr>
